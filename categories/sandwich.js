...
function updateCart() {
  ...
  if (cart.length === 0) {
    cartListEl.innerHTML = `<p style="color:rgba(255,255,255,0.5); text-align:center; margin-top:30px;">Cart is empty 🍽️</p>`;
  }
...
const sandwichItems = [
  { name: "Veg Sandwich",          price: 120, image: "../image/sandwich.png" },
  { name: "Chicken Sandwich",      price: 150, image: "../image/sandwich.png" },
  { name: "Double Patty Sandwich", price: 180, image: "../image/sandwich.png" },
  { name: "Cheese Sandwich",       price: 160, image: "../image/sandwich.png" },

];

const sandwichGrid = document.getElementById("sandwichGrid");
